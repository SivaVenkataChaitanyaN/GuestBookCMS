<?php
	...
	*/
	...
	$fileOutput = file_get_contents(rtrim($_SERVER['DOCUMENT_ROOT'], '/')."/library/includes/configuration.php");
	
	file_put_contents(rtrim($_SERVER['DOCUMENT_ROOT'], '/')."/library/includes/back_configuration.php", $fileOutput);
	
	file_put_contents(rtrim($_SERVER['DOCUMENT_ROOT'], '/')."/library/includes/configuration.php", $output);
